...
import us.zoom.sdk.ZoomInstantSDKPreProcessRawData;
...
public class YUVConvert {
    ...
    public static void addWaterMark(ZoomInstantSDKPreProcessRawData rawData, WaterMarkData waterMark, int off_x,
