...
import us.zoom.sdk.ZoomInstantSDKVideoCapability;
import us.zoom.sdk.ZoomInstantSDKVideoSender;
import us.zoom.sdk.ZoomInstantSDKVideoSource;

public class VirtualVideoSource implements ZoomInstantSDKVideoSource {
    ...
    private ZoomInstantSDKVideoSender sender;
...
//    }
    ...
    @Override
    public void onInitialize(ZoomInstantSDKVideoSender sender, List<ZoomInstantSDKVideoCapability> support_cap_list, ZoomInstantSDKVideoCapability suggest_cap) {
        this.sender = sender;
...
//                frameTwo = new VideoFrame(byteBuffer, bitmap.getWidth(), bitmap.getHeight());
    ...
    @Override
    public void onPropertyChange(List<ZoomInstantSDKVideoCapability> support_cap_list, ZoomInstantSDKVideoCapability suggest_cap) {
